                                      ...
                                      builder: (context, constraints) {
                                        ...
                                        if (isCompact) {
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            spacing: AppSpacing.sm,
                                            children: [titleBlock, Align(alignment: Alignment.centerRight, child: actions)],
                                          );
                                        }
          ...
          return InkWell(
            ...
            child: Container(
              ...
              child: Row(
                ...
                spacing: 8,
                children: [
                  Icon(Icons.dashboard_rounded, size: 18, color: Theme.of(context).colorScheme.primary),
                  Text('Dashboard', style: Theme.of(context).textTheme.labelLarge?.copyWith(color: AppColors.lightPrimaryText)),
                ],
              ),
            ),
          );
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              spacing: 8,
              children: [
                Icon(Icons.login_rounded, size: 18, color: Theme.of(context).colorScheme.primary),
                Text('Login', style: Theme.of(context).textTheme.labelLarge?.copyWith(color: AppColors.lightPrimaryText)),
              ],
            ),
          ),
        );
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          icon: Icon(Icons.language_rounded, color: Theme.of(context).colorScheme.primary, size: 20),
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: AppNetworkImage(url: shelter.imageUrl, height: 180, width: double.infinity, fit: BoxFit.cover),
                ),
                Positioned(
                  top: 12,
                  right: 12,
                  child: Container(
                    ...
                    child: Row(
                      spacing: 4,
                      children: [
                        const Icon(Icons.star_rounded, color: AppColors.lightAccent, size: 16),
                        Text(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            final ok = await showModalBottomSheet<bool>(
                              ...
                              builder: (context) => _AdminDeleteShelterSheet(name: shelter.name),
                            );
                            if (ok == true) {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.arrow_forward_ios_rounded, size: 16, color: AppColors.lightHint),
                    ],
                  ),
                  Row(
                    spacing: 4,
...
class SupportAppCard extends StatelessWidget {
  ...
  const SupportAppCard({super.key, required this.onTap});
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.volunteer_activism_rounded, color: Theme.of(context).colorScheme.primary),
            ),
            const SizedBox(width: AppSpacing.md),
            Expanded(
              child: Column(
...
class _AdminDeleteShelterSheet extends StatelessWidget {
  final String name;
  const _AdminDeleteShelterSheet({required this.name});
